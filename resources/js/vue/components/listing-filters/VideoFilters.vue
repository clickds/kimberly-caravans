    ...
    <div class="pt-4 bg-gallery">
      <div class="container mx-auto px-standard">
        <div class="flex flex-wrap -mx-2">
          <div class="mb-2 px-2 w-full md:w-1/2 lg:w-1/5" v-if="categories.length > 0">
            <custom-select
              label="name"
              :options="categories"
          ...
          <div class="mb-2 px-2 w-full md:w-1/2 lg:w-1/5" v-if="dealers.length > 0">
            <custom-select
              label="name"
              :options="dealers"
              placeholder="Dealer"
          ...
          <div class="mb-2 px-2 w-full md:w-1/2 lg:w-1/5" v-if="rangeNames.length > 0">
            <custom-select
              :options="rangeNames"
              placeholder="Ranges"
          ...
          <div class="mb-2 px-2 w-full md:w-1/2 lg:w-1/5">
            <datepicker
              :value="dateFrom"
...
export default {
  ...
  created() {
    ...
    this.selectedCategoryIds = convertArrayItemsToIntegers(
      urlParams.getAll("video_category_ids[]")
    );
