        ...
        <div class="relative flex flex-col">
            ...
            >
                ...
                <div class="w-full flex flex-row justify-between text-base md:text-xl" v-else>
                    <div>Compare upto 3 motorhomes ({{ motorhomes.length }})</div>
                    <div class="flex flex-row items-center space-x-5">
                        <span class="cursor-pointer underline text-base" @click="removeAllMotorhomes" v-if="motorhomes.length > 0">Clear all</span>
                        <i
                            class="fas text-3xl"
...
<script>
import MotorhomeComparisonList from "./MotorhomeComparisonList";
