...
@section('title', "{$motorhomeRange->name} Feature Gallery Images")

@section('page-title', "{$motorhomeRange->name} Feature Gallery Images")
...
@section('page-actions')
  ...
  @include('admin._partials.button', [
    'url' => route('admin.motorhome-ranges.gallery.upload-multiple.create', [
      ...
      'galleryType' => 'feature-gallery-images',
    ]),
    'text' => 'Upload Multiple',
  ])
  @include('admin._partials.page-actions', [
    'name' => 'gallery image',
    'url'  => route('admin.motorhome-ranges.feature-gallery-images.create', $motorhomeRange)
  ])
@endsection
        ...
        <template #row-cells-{{ $image->id }}>
          ...
          <td>
            @include('admin._partials.table-row-action-cell', [
              'destroy' => route('admin.motorhome-ranges.feature-gallery-images.destroy', [
                'motorhomeRange' => $motorhomeRange,
                'feature_gallery_image' => $image,
              ])
            ])
          </td>
        </template>
