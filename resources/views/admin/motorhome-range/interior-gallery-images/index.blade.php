...
@section('title', "{$motorhomeRange->name} Interior Gallery Images")

@section('page-title', "{$motorhomeRange->name} Interior Gallery Images")
...
@section('page-actions')
  ...
  @include('admin._partials.button', [
    'url' => route('admin.motorhome-ranges.gallery.upload-multiple.create', [
      ...
      'galleryType' => 'interior-gallery-images',
    ]),
    'text' => 'Upload Multiple',
  ])
  @include('admin._partials.page-actions', [
    'name' => 'gallery image',
    'url'  => route('admin.motorhome-ranges.interior-gallery-images.create', $motorhomeRange)
  ])
@endsection
        ...
        <template #row-cells-{{ $image->id }}>
          ...
          <td>
            @include('admin._partials.table-row-action-cell', [
              'destroy' => route('admin.motorhome-ranges.interior-gallery-images.destroy', [
                'motorhomeRange' => $motorhomeRange,
