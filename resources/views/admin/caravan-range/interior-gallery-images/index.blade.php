...
@section('title', "{$caravanRange->name} Interior Gallery Images")

@section('page-title', "{$caravanRange->name} Interior Gallery Images")
...
@section('page-actions')
  ...
  @include('admin._partials.page-actions', [
    'name' => 'gallery image',
    'url'  => route('admin.caravan-ranges.interior-gallery-images.create', $caravanRange)
  ])
@endsection
        ...
        <template #row-cells-{{ $image->id }}>
          ...
          <td>
            @include('admin._partials.table-row-action-cell', [
              'destroy' => route('admin.caravan-ranges.interior-gallery-images.destroy', [
                'caravanRange' => $caravanRange,
