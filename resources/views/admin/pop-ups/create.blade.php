...
@section('title', 'Create Pop Up')
@section('page-title', 'Create Pop Up')
...
@section('page')
  <div class="w-full">
    <pop-up csrf-token="{{ csrf_token() }}"
      ...
      :initial-appears-on-all-pages='@json(old('appears_on_all_pages', $popUp->appears_on_all_pages))'
      :initial-appears-on-new-motorhome-pages='@json(old('appears_on_new_motorhome_pages', $popUp->appears_on_new_motorhome_pages))'
      :initial-appears-on-new-caravan-pages='@json(old('appears_on_new_caravan_pages', $popUp->appears_on_new_caravan_pages))'
      :initial-appears-on-used-motorhome-pages='@json(old('appears_on_used_motorhome_pages', $popUp->appears_on_used_motorhome_pages))'
      :initial-appears-on-used-caravan-pages='@json(old('appears_on_used_caravan_pages', $popUp->appears_on_used_caravan_pages))'
      ...
      :sites='@json($sites)'
      url='{{ route('admin.pop-ups.store') }}'></pop-up>
  </div>
@endsection