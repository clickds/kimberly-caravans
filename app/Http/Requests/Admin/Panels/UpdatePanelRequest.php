...
class UpdatePanelRequest extends FormRequest
{
    ...
    private function featuredImagePanelRules(): array
    {
        ...
        if ($this->panelHasMediaInCollection('featuredImage')) {
    ...
    private function imagePanelRules(): array
    {
        ...
        if ($this->panelHasMediaInCollection('image')) {
        } else {
    ...
    private function panelHasMediaInCollection(string $collectionName): bool
    {
        $panel = $this->getPanel();
        if (is_null($panel->getFirstMedia($collectionName))) {
            return false;
        }
        return true;
    }
