...
class FeatureGalleryImagesController extends Controller
{
    ...
    {
        $galleryImages = $motorhomeRange->getMedia('featureGallery');

        return view('admin.motorhome-range.feature-gallery-images.index', [
    ...
    {
        return view('admin.motorhome-range.feature-gallery-images.create', [
            'motorhomeRange' => $motorhomeRange,
        ]);
    }
    ...
    public function store(StoreRequest $request, MotorhomeRange $motorhomeRange): RedirectResponse
    {
        ...
        return redirect()->route('admin.motorhome-ranges.feature-gallery-images.index', $motorhomeRange);
    }

    public function destroy(MotorhomeRange $motorhomeRange, Media $feature_gallery_image): RedirectResponse
    {
