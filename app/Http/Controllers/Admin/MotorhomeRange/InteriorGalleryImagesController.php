...
class InteriorGalleryImagesController extends Controller
{
    ...
    {
        $galleryImages = $motorhomeRange->getMedia('interiorGallery');

        return view('admin.motorhome-range.interior-gallery-images.index', [
    ...
    {
        return view('admin.motorhome-range.interior-gallery-images.create', [
            'motorhomeRange' => $motorhomeRange,
        ]);
    }
    ...
    public function store(StoreRequest $request, MotorhomeRange $motorhomeRange): RedirectResponse
    {
        ...
        return redirect()->route('admin.motorhome-ranges.interior-gallery-images.index', $motorhomeRange);
    }

    public function destroy(MotorhomeRange $motorhomeRange, Media $interior_gallery_image): RedirectResponse
    {
