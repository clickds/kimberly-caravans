...
class StoreTest extends TestCase
{
    ...
    public function test_successful(): void
    {
        ...
        $response->assertRedirect(route('admin.sites.opening-times.index', $site));
        $this->assertDatabaseHas('opening_times', $data);
    }

    private function submit(Site $site, array $data): TestResponse
    {
        $user = $this->createSuperUser();
        $url = route('admin.sites.opening-times.store', [
            'site' => $site,
        ]);
