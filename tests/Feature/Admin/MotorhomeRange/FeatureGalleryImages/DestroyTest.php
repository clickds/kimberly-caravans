...
namespace Tests\Feature\Admin\MotorhomeRange\FeatureGalleryImages;
...
class DestroyTest extends TestCase
{
    ...
    public function test_successful()
    {
        ...
        $response->assertRedirect(route('admin.motorhome-ranges.feature-gallery-images.index', $motorhomeRange));
    ...
    {
        return route('admin.motorhome-ranges.feature-gallery-images.destroy', [
