...
namespace Tests\Feature\Admin\MotorhomeRange\InteriorGalleryImages;
...
class DestroyTest extends TestCase
{
    ...
    public function test_successful()
    {
        ...
        $response->assertRedirect(route('admin.motorhome-ranges.interior-gallery-images.index', $motorhomeRange));
    ...
    {
        return route('admin.motorhome-ranges.interior-gallery-images.destroy', [
