...
class UpdateTest extends TestCase
{
    ...
    public function test_syncing_stock_item_images(): void
    {
        ...
        $stockImage = factory(Media::class)->create([
            ...
            'model_id' => $motorhome->motorhome_range_id,
        ]);
        $data = $this->validFields([
    ...
    public function test_syncing_sites()
    {
        ...
        $this->assertDatabaseMissing('motorhome_site', [
            'motorhome_id' => $motorhome->id,
            'site_id' => $old_site->id,
        ]);
    }
    ...
    public function test_name_is_unique_based_on_year_and_range()
    {
        $motorhome = $this->createMotorhome();
        $otherMotorhome = $this->createMotorhome([
            'motorhome_range_id' => $motorhome->motorhome_range_id,
        ]);
        $data = $this->validFields([
            'name' => $otherMotorhome->name,
            'year' => $otherMotorhome->year,
        ]);
    ...
    private function submit(Motorhome $motorhome, array $data = [])
    {
    ...
    {
        return route('admin.motorhome-ranges.motorhomes.update', [
            'motorhomeRange' => $motorhome->motorhomeRange,
            'motorhome' => $motorhome,
        ]);
    }
