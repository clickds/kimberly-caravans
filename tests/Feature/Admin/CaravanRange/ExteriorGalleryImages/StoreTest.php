...
namespace Tests\Feature\Admin\CaravanRange\ExteriorGalleryImages;
...
class StoreTest extends TestCase
{
    ...
    public function test_successful()
    {
        ...
        $response->assertRedirect(route('admin.caravan-ranges.exterior-gallery-images.index', $caravanRange));
    ...
    private function url(CaravanRange $caravanRangeRange)
    {
        return route('admin.caravan-ranges.exterior-gallery-images.store', [
            'caravanRange' => $caravanRangeRange,
        ]);
    }
