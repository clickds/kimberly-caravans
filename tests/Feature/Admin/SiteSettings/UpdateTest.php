...
class UpdateTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->siteSetting = factory(SiteSetting::class)->create();
    }
    ...
    public function test_required_validation(string $inputName): void
    {
        ...
        $response = $this->submit($this->siteSetting, $data);
    ...
    {
        $this->markTestIncomplete('Currently there is only one site setting, so we can\'t write a reliable test');
    }
    ...
    private function submit(SiteSetting $siteSetting, array $data): TestResponse
    {
