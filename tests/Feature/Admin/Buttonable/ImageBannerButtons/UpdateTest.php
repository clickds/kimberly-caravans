...
class UpdateTest extends TestCase
{
    ...
    public function test_required_validation(string $inputName): void
    {
        ...
        $response = $this->submit($button, $data);
    ...
    private function submit(Button $button, array $data): TestResponse
    {
        $user = $this->createSuperUser();
        $url = route('admin.image-banners.buttons.update', [
    ...
    private function createButton(array $attributes = [])
    {
