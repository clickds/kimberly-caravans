...
class MotorhomeStockItemTest extends TestCase
{
    ...
    public function test_cannot_set_conversion_to_value_not_in_motorhome_conversions_constant()
    {
        $item = new MotorhomeStockItem;
    ...
    public function test_cannot_set_fuel_to_value_not_in_motorhome_fuels_constant()
    {
        $item = new MotorhomeStockItem;
    ...
    public function test_cannot_set_transmission_to_value_not_in_motorhome_transmissions_constant()
    {
        $item = new MotorhomeStockItem;
